  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo e(route('blog.store')); ?>" method="POST" enctype="multipart/form-data" class="p-4">
            <?php echo csrf_field(); ?>
            <!-- Campo oculto para la fecha de publicación -->
            <input type="hidden" name="fecha_pub" value="<?php echo e(date('Y-m-d')); ?>">
...
</div><?php /**PATH C:\xampp\htdocs\EcoMercado\resources\views/blog/ceaBlog.blade.php ENDPATH**/ ?>
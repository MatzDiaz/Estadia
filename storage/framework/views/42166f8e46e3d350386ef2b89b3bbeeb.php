                ...
                <div class="row g-0">
                    ...
                    <div class="card-body p-md-5 mx-md-4">
                        ...
                        <div class="text-center pt-1 mb-5 pb-1">
                            ...
                            <br><a class="text-muted" href="<?php echo e(route('verify')); ?>">¿Olvidó su contraseña?</a>
                        </div>

                        <div class="d-flex align-items-center justify-content-center pb-4">
                            <p class="mb-0 me-2">¿No tiene cuenta?</p>
                            <a href="<?php echo e(route('register')); ?>" type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-danger">Registrarse</a>
                        </div>
                    ...
                    <img src="<?php echo e(asset('assets/LogoComercio.png')); ?>"
...
<?php /**PATH C:\xampp\htdocs\EcoMercado\resources\views/auth/login.blade.php ENDPATH**/ ?>